...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'toast.noProvider': { ja: 'AI につながっていません (Claude / Copilot / Codex の CLI を入れてください)', en: 'AI isn\u2019t connected yet (install the Claude, Copilot, or Codex CLI)' },
  ...
  'ask.jumpToCard': { ja: 'この箇所の質問を表示', en: 'Show the question for this passage' },
